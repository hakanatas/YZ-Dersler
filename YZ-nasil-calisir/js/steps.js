...
export const STEPS = [
  {
    ...
    body: `
      ...
      <p>Gördün, değil mi? Peki Bıdık neden göremiyor? Çünkü Bıdık masaya bakmıyor; ona yalnızca sayılar gidiyor. <b>"Bıdık'ın gözüyle bak"</b> düğmesine bas, masayı Bıdık'ın gözüyle gör. Bir de şunu bil: kuralı burada biz biliyoruz, ama gerçek işlerde kuralı kimse yazamaz ("fotoğrafta kedi var mı?" için kural yazmayı dene!). Bu yüzden makineye kural değil örnek veriyoruz. Mantı masası, bu yöntemi gözünle kontrol edebilmen için basit tutuldu.</p>
  ...
  },
  {
    ...
    body: `
      ...
      <p><b>"Hadi düzelt!"</b> düğmesine bas ve izle: önce mantının sayıları soldan sağa akıyor, Bıdık tahminini söylüyor. Sonra <b>mavi ışıklar</b> beliriyor ve ters yöne, sağdan sola gidiyor. Bu, "hangi ip hataya ne kadar sebep oldu?" sorusunun cevabı. Ardından ipler biraz değişiyor ve hata puanı düşüyor. İşte öğrenmek dediğimiz şey tam olarak bu. Birkaç kez bas, her seferinde puan biraz daha düşsün.</p>
